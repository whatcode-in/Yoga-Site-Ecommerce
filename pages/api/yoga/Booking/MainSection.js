  ...
  useEffect(() => {
    ...
    if (participants === 1) {
      if (packageNumb !== 4) {
        ...
        setsharedroomcost(155 * night);
      } else {
        setindividualroomcost(499);
        setsharedroomcost(499);
      }
      if (ind === 1) {
        if (packageNumb === 4) {
          if (day === 4) {
        ...
        } else if (packageNumb === 7) {
          setTotalCost(165 * night);
        } else if (packageNumb === 14) {
          setTotalCost(165 * night);
        } else if (packageNumb == 21) {
          setTotalCost(165 * night);
        }
      } else if (ind === 2) {
        if (packageNumb !== 4) {
    ...
    console.log("heelele", participants, ind);
                    ...
                    <>
                      ...
                      >
                        ...
                        >
                          ...
                          <span className="price">€{individualroomcost}</span>
                      ...
                      >
                        ...
                        >
                          ...
                          <span className="price">€{sharedroomcost}</span>
                          <small>Total Price</small>
                        </div>
                      </li>
                    </>
